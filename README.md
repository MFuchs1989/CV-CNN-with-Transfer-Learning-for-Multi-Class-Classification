...
# Computer Vision: CNN with Transfer Learning for Multi-Label Classification
...
How I proceeded exactly and what results I achieved can be read in my blog post: [CV - CNN with Transfer Learning for Multi-Label Classification](https://michael-fuchs-python.netlify.app/2021/01/19/cv-cnn-with-transfer-learning-for-multi-label-classification/)
...
6. Start the notebook ```CNN with Transfer Learning for Multi-Label Classification.ipynb```.
...
```
C:.
│   CNN with Transfer Learning for Multi-Label Classification.ipynb
...
Here is the link to my blog post: [CV - CNN with Transfer Learning for Multi-Label Classification](https://michael-fuchs-python.netlify.app/2021/01/19/cv-cnn-with-transfer-learning-for-multi-label-classification/).
